...
class main(object):
    ...
    def runCamera(self):
        ...
        # print(name)
                    ...
                    cv2.rectangle(img, (x1, y1), (x2, y2), (0, 300, 0), 2)
                    cv2.rectangle(img, (x1, y2 - 35), (x2, y2), (0, 300, 0), cv2.FILLED)
                    # cv2.rectangle(img, (x1, y1), (x2, y2), (0, 255, 0), 2)
                    # cv2.rectangle(img, (x1, y2 - 35), (x2, y2), (0, 255, 0), cv2.FILLED)
                    #cv2.putText(img, name, (x1 + 6, y2 - 6), cv2.FONT_HERSHEY_COMPLEX, 1, (255, 255, 255), 2)
                    cv2.putText(img, name, (x1 + 6, y2 - 6), cv2.FONT_HERSHEY_COMPLEX, 1, (300, 300, 300), 2)
